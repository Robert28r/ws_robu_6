...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\robu\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\robu\hook\ament_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\..\build\robu\share\robu\hook\pythonpath_develop.bat"
